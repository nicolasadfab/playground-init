...
"absolute";b.style.top=a.y+"px";b.style.left=a.x+"px";b.style.width=a.width+"px";b.style.height=a.height+"px";b.style.background="red";document.body.appendChild(b)},getOffset:function(a){for(var b=0,c=0;a&&!isNaN(a.offsetLeft)&&!isNaN(a.offsetTop);)b+=a.offsetLeft-a.scrollLeft,c+=a.offsetTop-a.scrollTop,a=a.offsetParent;return{x:c,y:b}},checkXpath:function(a){return 0<PG.Util.getObjectFromXpath(a).length?!0:!1},getValueFromObject:function(a){var b="";PG.Util.not_null(a)&&"object"===typeof a&&(void 0!==
