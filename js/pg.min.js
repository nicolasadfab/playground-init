...
try{addToNamespace("Cache",cache)}catch(e$$12){throw Error("Cannot extends 'cache' to 'Adfab.playground.Cache'");};var pgutil={not_null:function(a){return null!==a?"undefined"!==typeof a?""!==a?!0:!1:!1:!1},pointOnBox:function(a,b){var c=!1;a.x>b.x&&a.x<parseInt(b.x+b.width,10)&&a.y>b.y&&a.y<parseInt(b.y+b.height,10)&&(c=!0);return c},getObjectFromXpath:function(a){a=document.evaluate(a,document.documentElement,null,XPathResult.ORDERED_NODE_ITERATOR_TYPE,null);var b=[];if(a)for(var c=a.iterateNext();c;)b.push(c),c=a.iterateNext();return b},createShape:function(a){alert("test");var b=document.createElement("div");
b.style.position="absolute";b.style.top=a.y+"px";b.style.left=a.x+"px";b.style.width=a.width+"px";b.style.height=a.height+"px";b.style.background="red";document.body.appendChild(b)},checkXpath:function(a){return 0<PG.Util.getObjectFromXpath(a).length?!0:!1},getValueFromObject:function(a){var b="";PG.Util.not_null(a)&&"object"===typeof a&&(void 0!==a.value?b=a.value:void 0!==a.innerHTML&&(b=a.innerHTML));return b.replace(/^\s+/g,"").replace(/\s+$/g,"")},createCookie:function(a,b,c){if(PG.Cache.localstorage)localStorage.setItem(PG.Config.ns+
"."+a,b);else{if(c){var d=new Date;d.setTime(d.getTime()+864E5*c);c="; expires\x3d"+d.toGMTString()}else c="";document.cookie=PG.Config.ns+"."+a+"\x3d"+encodeURIComponent(b)+c+"; path\x3d/"}},GenerateUniqueId:function(){var a=PG.Util.readCookie("unique-id");if(!PG.Util.not_null(a)){var a="abcdefghijklmnopkrstuvwxyz123456789"+(new Date).getTime(),b="",c;for(c=a.length-1;0<c;c--)b+=a.charAt(Math.floor(Math.random()*(c+1))),b+=a.charAt(c);a=b.slice(0,20);PG.Util.createCookie("unique-id",a)}PG.Util.not_null(PG.User)&&
(PG.User.uid=a);return a},readCookie:function(a){if(PG.Cache.localstorage)return localStorage.getItem(PG.Config.ns+"."+a);a=PG.Config.ns+"."+a+"\x3d";for(var b=document.cookie.split(";"),c=0,d="",c=0;c<b.length;c++){for(d=b[c];" "==d.charAt(0);)d=d.substring(1,d.length);if(0==d.indexOf(a))return decodeURIComponent(d.substring(a.length,d.length))}return null},eraseCookie:function(a){if(PG.Cache.localstorage)return localStorage.removeItem(PG.Config.ns+"."+a);document.cookie=PG.Config.ns+"."+a+"\x3d''; expires\x3dThu, 01 Jan 1970 00:00:01 GMT; path\x3d/"},
matchUrl:function(a){try{return a=eval(a),a.test(window.location.href)}catch(b){return!1}},isUrlValid:function(a){return 0<=PG.Config.env[PG.Config.mode].url.indexOf(a)?!1:!0},log:function(a){PG.Config.debug&&(console.log("%c\x3e PLAYGROUND DEBUG ::","color:blue; font-weight:bold;"),console.log(a))},getDomElemntFromItem:function(a){var b=null;"id"===a.selector?b=document.getElementById(a.name):"class"===a.selector&&(b=document.getElementsByClassName(a.name),null!==b&&0<b.length&&(b=b[0]));return b},
fireEvt:function(a,b,c){if(window.dispatchEvent){var d=document.createEvent("Event");d.initEvent(a,!0,!0);d.data=c;b.dispatchEvent(d)}else window.fireEvent&&b.fireEvent(a)},saysWho:function(){var a=navigator.appName,b=navigator.userAgent,c,d=b.match(/(opera|chrome|safari|firefox|msie)\/?\s*(\.?\d+(\.\d+)*)/i);if(d&&null!=(c=b.match(/version\/([\.\d]+)/i)))d[2]=c[1];return d=d?[d[1],d[2]]:[a,navigator.appVersion,"-?"]},loadJs:function(a,b){var c=document.createElement("script"),d;c.type="text/javascript";
c.async=!0;c.src=a;d=document.getElementsByTagName("script")[0];d.parentNode.insertBefore(c,d);c.addEventListener("load",function(){b&&b()})}};try{addToNamespace("Util",pgutil),addToNamespace("Config",pl_config)}catch(e$$14){throw Error("Cannot extends 'Util' to 'Adfab.playground.Util'");};var PG=Adfab.Playground,init;
