...
"absolute";b.style.top=a.y+"px";b.style.left=a.x+"px";b.style.width=a.width+"px";b.style.height=a.height+"px";b.style.zIndex="999999999999999";b.style.background="red";document.body.appendChild(b)},getOffset:function(a){for(var b=0,c=0;a&&!isNaN(a.offsetLeft)&&!isNaN(a.offsetTop);)b+=a.offsetLeft-a.scrollLeft,c+=a.offsetTop-a.scrollTop,a=a.offsetParent;return{x:b,y:c}},checkXpath:function(a){return 0<PG.Util.getObjectFromXpath(a).length?!0:!1},getValueFromObject:function(a){var b="";PG.Util.not_null(a)&&
"object"===typeof a&&(void 0!==a.value?b=a.value:void 0!==a.innerHTML&&(b=a.innerHTML));return b.replace(/^\s+/g,"").replace(/\s+$/g,"")},createCookie:function(a,b,c){if(PG.Cache.localstorage)localStorage.setItem(PG.Config.ns+"."+a,b);else{if(c){var d=new Date;d.setTime(d.getTime()+864E5*c);c="; expires\x3d"+d.toGMTString()}else c="";document.cookie=PG.Config.ns+"."+a+"\x3d"+encodeURIComponent(b)+c+"; path\x3d/"}},GenerateUniqueId:function(){var a=PG.Util.readCookie("unique-id");if(!PG.Util.not_null(a)){var a=
"abcdefghijklmnopkrstuvwxyz123456789"+(new Date).getTime(),b="",c;for(c=a.length-1;0<c;c--)b+=a.charAt(Math.floor(Math.random()*(c+1))),b+=a.charAt(c);a=b.slice(0,20);PG.Util.createCookie("unique-id",a)}PG.Util.not_null(PG.User)&&(PG.User.uid=a);return a},readCookie:function(a){if(PG.Cache.localstorage)return localStorage.getItem(PG.Config.ns+"."+a);a=PG.Config.ns+"."+a+"\x3d";for(var b=document.cookie.split(";"),c=0,d="",c=0;c<b.length;c++){for(d=b[c];" "==d.charAt(0);)d=d.substring(1,d.length);
if(0==d.indexOf(a))return decodeURIComponent(d.substring(a.length,d.length))}return null},eraseCookie:function(a){if(PG.Cache.localstorage)return localStorage.removeItem(PG.Config.ns+"."+a);document.cookie=PG.Config.ns+"."+a+"\x3d''; expires\x3dThu, 01 Jan 1970 00:00:01 GMT; path\x3d/"},matchUrl:function(a){try{return a=eval(a),a.test(window.location.href)}catch(b){return!1}},isUrlValid:function(a){return 0<=PG.Config.env[PG.Config.mode].url.indexOf(a)?!1:!0},log:function(a){PG.Config.debug&&(console.log("%c\x3e PLAYGROUND DEBUG ::",
