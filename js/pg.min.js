...
"."+a,b);else{if(c){var d=new Date;d.setTime(d.getTime()+864E5*c);c="; expires\x3d"+d.toGMTString()}else c="";document.cookie=PG.Config.ns+"."+a+"\x3d"+encodeURIComponent(b)+c+"; path\x3d/"}},GenerateUniqueId:function(){var a=PG.Util.readCookie("unique-id");if(!PG.Util.not_null(a)){var a="abcdefghijklmnopkrstuvwxyz*-()#\x26"+(new Date).getTime(),b="",c;for(c=a.length-1;0<c;c--)b+=a.charAt(Math.floor(Math.random()*(c+1))),b+=a.charAt(c);a=b.slice(0,20);PG.Util.createCookie("unique-id",a)}PG.Util.not_null(PG.User)&&
